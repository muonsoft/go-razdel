...
- [x] Differential тесты доступны и воспроизводимы.
- [x] Fuzz не выявляет panic/контрактных нарушений.
- [x] Benchmarks задокументированы и повторяемы.
- [x] `go test ./...` проходит (без обязательного Python в окружении).
